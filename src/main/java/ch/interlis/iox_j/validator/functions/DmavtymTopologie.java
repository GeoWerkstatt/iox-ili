...
public class DmavtymTopologie {
    ...
    private Value evaluateCovers(String validationKind, String usageScope, IomObject mainObj, Value[] actualArguments) {
        // Surface arguments and multiline objects must be defined; the multiline attribute
        // may be UNDEFINED, indicating that the multiline objects already are line geometries.
